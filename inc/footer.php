    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p style="color: #FFF">Trinidad-Beni-Bolivia</p>
                ...
                E-mail: <a href="#" target="_blank" style="color: #5bc0de"> &nbsp;trajestipicosjosechavesuarez@gmail.com </a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">TRAJES TÍPICOS FOLKLÓRICOS ONLINE &copy; 2022</h5>
</footer>
